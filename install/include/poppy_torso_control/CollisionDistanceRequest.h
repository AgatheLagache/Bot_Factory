...
bool operator==(const ::poppy_torso_control::CollisionDistanceRequest_<ContainerAllocator1> & lhs, const ::poppy_torso_control::CollisionDistanceRequest_<ContainerAllocator2> & rhs)
{
  return lhs.group == rhs.group &&
    lhs.offset == rhs.offset &&
    lhs.offset_values == rhs.offset_values;
}
