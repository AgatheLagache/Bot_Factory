...
bool operator==(const ::poppy_torso_control::ForwardKinematicsRequest_<ContainerAllocator1> & lhs, const ::poppy_torso_control::ForwardKinematicsRequest_<ContainerAllocator2> & rhs)
{
